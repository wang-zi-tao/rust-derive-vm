...
impl Type {
    ...
    pub fn to_array(self) -> Result<Type> {
    ...
    pub fn from_symbol(class_loader: &dyn ClassLoaderTrait, symbol: &str) -> Result<Self> {
        Ok(match symbol {
...
impl GeneraicTypeTrait for GenericType {
    ...
    fn java_type(&self) -> &Type {
        &self.java_type
    }
}
// impl From<Arc<JavaClass>> for GenericType {
// fn from(class: Arc<JavaClass>) -> Self {
// let java_type = if class.is_primitive() {
// Type::Primitive(match &**class.name() {
...
// _ => panic!("not a primitive type:{:?}", class),
// })
// } else {
// Type::JavaClass(class.clone())
// };
// GenericType {
// java_type,
// raw_class: class,
